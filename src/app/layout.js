    ...
    <html lang="es" className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
     <body className="bg-background text-foreground font-sans">
        <nav className="w-3/4 mx-auto mt-6 bg-altern rounded-2xl text-details px-6 py-4 flex justify-between items-center shadow-md z-50">
          <h1 className="text-3xl tracking-wider drop-shadow-md">Ciclo Freestyle</h1>
          <div className="space-x-6 text-xl tracking-wide">
            <Link href="/" className="hover:underline hover:text-details">Inicio</Link>
            <Link href="/torneo" className="hover:underline hover:text-details">Torneo</Link>
            <Link href="/fechas" className="hover:underline hover:text-details">Fechas</Link>
          </div>
        </nav>
